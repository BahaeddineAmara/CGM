...
{
    public partial class TeleliquidationPersonneDetailForm : Form
    {
        private int personneId;
        private string personneName;

        public TeleliquidationPersonneDetailForm(int personneId)
        {
            InitializeComponent();
            this.personneId = personneId;
        }

        private void TeleliquidationPersonneDetailForm_Load(object sender, EventArgs e)
        {
            LoadData();
        ...
        private void LoadData()
        {
            ...
            string query = @"SELECT t.*, p.nom AS personne_nom 
                            FROM teleliquidation_personnes t
                            JOIN personnes p ON t.personne_id = p.id
                            WHERE t.personne_id = @personneId AND t.mois = @mois AND t.annee = @annee";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = @"UPDATE teleliquidation_personnes SET 
